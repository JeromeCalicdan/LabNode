...
var FileStreamRotator = __importStar(require("file-stream-rotator"));
...
exports.logConfiguration = {
    ...
    winston: {
        ...
        format: winston_1.default.format.combine(winston_1.default.format.label({
            label: 'node-api',
        }), winston_1.default.format.timestamp({ format: 'YYYY-MM-DD HH:mm:ss' }), winston_1.default.format.printf(function (info) {
